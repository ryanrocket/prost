...
const PROST = {
	...
	__draft: function(a, b, c) {
		var _scss = {
			default:
				'[prost], .prost {height: auto;width: 305px;text-align:left!important;background: #fff;padding: 8px;box-shadow: 0 2px 20px 0 rgba(0,0,0,.1);border-radius:5px;}' +
				'[prost-advert], .prost-advert {height: 100px; width: 130px; border-radius: 2px; left: 0; margin-right: 10px;}' +
				'[prost-desc], .prost-desc {font-family: "Roboto", Helvetica, sans-serif;font-size:12px;margin-top: 8px; line-height: 1.35; color: #637381;font-weight: 300;width: 145px;right: 0; float: right;}' +
			...
			stripedef:
				'[prost], .prost {text-align: left!important;background: repeating-linear-gradient(135deg, #f9f9f9, #f9f9f9 5px, rgba(0,0,0,0) 5px, rgba(0,0,0,0) 10px);height: auto;width: 305px;padding: 8px;box-shadow: 0 2px 20px 0 rgba(0,0,0,.1);border-radius:5px;}' +
				'[prost-advert], .prost-advert {height: 100px; width: 130px; border-radius: 2px; left: 0; margin-right: 10px;}' +
				'[prost-desc], .prost-desc {font-family: "Roboto", Helvetica, sans-serif;font-size:12px;margin-top: 8px; line-height: 1.35; color: #637381;font-weight: 300;width: 145px;right: 0; float: right;}' +
				'[prost-fine], .prost-fine {font-family: "Roboto", Helvetica, sans-serif;font-size:9.5px;color: #C5CDD0;margin: 9px 0;text-transform: uppercase;line-height: 1.25;font-weight: 500; width: 145px;right: 0; float: right; top:0;}',
			long:
				...
				'[prost-desc], .prost-desc {font-family: "Roboto", Helvetica, sans-serif;padding-top:12px;font-size:12px;margin: 8px 0; line-height: 1.35; color: #637381;font-weight: 300;width: auto;bottom: 0; text-align: center;}' +
				'[prost-fine], .prost-fine {font-family: "Roboto", Helvetica, sans-serif;font-size:9.5px;color: #C5CDD0;margin: 9px 0;text-transform: uppercase;line-height: 1.25;font-weight: 500; width: auto;bottom: 0; text-align: center;}',
			stripelon:
